      ...
      <Container>
        <Content container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            <Button variant="contained" color="primary" href="http://www.cmscbe.net/cmsmatriculationganapathy.html">
              View official site&nbsp;&nbsp;&nbsp;<i className="fa fa-external-link" style={{ fontSize: 15 }}></i>
            </Button>
          </Grid>
          <ImageContainer item xs={12} md={6}>
            <ResponsiveImage src="https://bit.ly/3WCnvDk" alt="Illustration" />
          </ImageContainer>
        </Content>
      </Container>
      <Container>
        <Content container spacing={4}>
          ...
          <ImageContainer item xs={12} md={6}>
            <ResponsiveImage
              src="https://lh3.googleusercontent.com/p/AF1QipOgLmY7YojiOTPnZFYdZ69Q5YwbIrVxpC0dRvBY=s1360-w1360-h1020"
              alt="Illustration"
            />
          </ImageContainer>
        </Content>
